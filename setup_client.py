...
dashboard_file_content = dashboard_file_content.replace("CURRENT_DIR", current_dir)
dashboard_file_content = dashboard_file_content.replace("FILENAME", script_filename)
